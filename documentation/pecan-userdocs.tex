...
\subsubsection{PralineAutomaton}

\verb+PralineAutomaton+ is a factory object to create automatons for Praline.
...
\verb+mkAut <input names> <input bases>+ returns a \verb+PralineAutomaton+ with the given input names and bases.
...
\verb+buildAut <automaton>+ returns a \verb+PralinePecanTerm+ containing the built automaton of the given \verb+PralineAutomaton+ object.
